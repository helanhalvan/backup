...
void _enc__trace_LinkedList(pony_ctx_t* _ctx_arg, void* p)
{
  ...
  pony_traceobject((*_ctx), _enc__field_first, _enc__trace_Node);
}
...
void* _enc__method_LinkedList_preppend(pony_ctx_t** _ctx, _enc__passive_LinkedList_t* _this, encore_arg_t _enc__arg_data)
{
  ...
  else
  {
    ...
    check_receiver(_fieldacc_6, ".", "this.first", "preppend", "\"./List.enc\" (line 10, column 25)");
...
void* _enc__method_LinkedList_append(pony_ctx_t** _ctx, _enc__passive_LinkedList_t* _this, encore_arg_t _enc__arg_data)
{
  ...
  else
  {
    /* this.first.append(data) */;
    _enc__passive_Node_t* _fieldacc_6 = (*_this)._enc__field_first;
    check_receiver(_fieldacc_6, ".", "this.first", "append", "\"./List.enc\" (line 18, column 25)");
...
static void _enc__dispatch_LinkedList(pony_ctx_t** _ctx, pony_actor_t* _a, pony_msg_t* _m)
{
  /* Stub! Might be used when we have dynamic dispatch on passive classes */
}


pony_type_t _enc__passive_LinkedList_type = {.id=_ENC__ID_LinkedList, .size=sizeof(_enc__passive_LinkedList_t), .trace=_enc__trace_LinkedList, .dispatch=_enc__dispatch_LinkedList, .vtable=trait_method_selector};
