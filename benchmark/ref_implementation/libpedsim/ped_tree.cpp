...
int Ped::Ttree::getNumAgents() const {
    if(isleaf) {
        return agents.size();
    }
    return tree1->getNumAgents() + tree2->getNumAgents() + tree3->getNumAgents() + tree4->getNumAgents();
}

/*
Ttree* Ped::Ttree::getSubtree(int number) {
