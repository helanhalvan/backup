...
void _enc__type_init_Either_Right(_enc__passive_Either_Right_t* this, ... )
{
  va_list params;
...
void _enc__trace_Either_Right(pony_ctx_t* _ctx_arg, void* p)
{
  ...
  _enc__passive_Either_Right_t* _this = p;
  encore_arg_t _enc__field_x = _this->_enc__field_x;
  encore_trace_polymorphic_variable((*_ctx), _this->_enc__type_b, _enc__field_x);
}


_enc__passive_Either_Right_t* _enc__constructor_Either_Right(pony_ctx_t** _ctx)
{
  _enc__passive_Either_Right_t* this = ((_enc__passive_Either_Right_t*) encore_alloc((*_ctx), sizeof(_enc__passive_Either_Right_t)));
  this->_enc__self_type = (&(_enc__passive_Either_Right_type));
  return this;
}


void* _enc__method_Either_Right__init(pony_ctx_t** _ctx, _enc__passive_Either_Right_t* _this, encore_arg_t _enc__arg_x)
{
  pony_type_t* _enc__type_a = (*((_enc__passive_Either_Right_t*) _this))._enc__type_a;
  pony_type_t* _enc__type_b = (*((_enc__passive_Either_Right_t*) _this))._enc__type_b;
  (*({ _this;}))._enc__field_x = _enc__arg_x;
  return UNIT;
}


option_t* _enc__method_Either_Right_Left(pony_ctx_t** _ctx, _enc__passive_Either_Right_t* _this)
{
  pony_type_t* _enc__type_a = (*((_enc__passive_Either_Right_t*) _this))._enc__type_a;
  pony_type_t* _enc__type_b = (*((_enc__passive_Either_Right_t*) _this))._enc__type_b;
...
option_t* _enc__method_Either_Right_Right(pony_ctx_t** _ctx, _enc__passive_Either_Right_t* _this)
{
  pony_type_t* _enc__type_a = (*((_enc__passive_Either_Right_t*) _this))._enc__type_a;
  pony_type_t* _enc__type_b = (*((_enc__passive_Either_Right_t*) _this))._enc__type_b;
...
_enc__trait_Either_Either_t* _enc__method_Either_Right_map(pony_ctx_t** _ctx, _enc__passive_Either_Right_t* _this, closure_t* _enc__arg_f)
{
  pony_type_t* _enc__type_a = (*((_enc__passive_Either_Right_t*) _this))._enc__type_a;
  pony_type_t* _enc__type_b = (*((_enc__passive_Either_Right_t*) _this))._enc__type_b;
  /* match this with
 ...
 */;
  ...
  if ((({int64_t _extractoCheck_17;
         _extractoCheck_17 = ((_this != NULL) && ({int64_t _optionCheck_15;
                                                   option_t* _extractedOption_13 = _enc__method_Either_Right_Left(_ctx, _this);
  ...
  else
  {
    ...
    if ((({int64_t _extractoCheck_11;
           _extractoCheck_11 = ((_this != NULL) && ({int64_t _optionCheck_9;
                                                     option_t* _extractedOption_7 = _enc__method_Either_Right_Right(_ctx, _this);
...
void* _enc__method_Either_Right_foreach(pony_ctx_t** _ctx, _enc__passive_Either_Right_t* _this, closure_t* _enc__arg_f)
{
  pony_type_t* _enc__type_a = (*((_enc__passive_Either_Right_t*) _this))._enc__type_a;
  pony_type_t* _enc__type_b = (*((_enc__passive_Either_Right_t*) _this))._enc__type_b;
  /* match this with
 ...
 */;
  ...
  if ((({int64_t _extractoCheck_14;
         _extractoCheck_14 = ((_this != NULL) && ({int64_t _optionCheck_12;
                                                   option_t* _extractedOption_10 = _enc__method_Either_Right_Left(_ctx, _this);
  ...
  else
  {
    ...
    if ((({int64_t _extractoCheck_8;
           _extractoCheck_8 = ((_this != NULL) && ({int64_t _optionCheck_6;
                                                    option_t* _extractedOption_4 = _enc__method_Either_Right_Right(_ctx, _this);
...
_enc__trait_Either_Either_t* _enc__method_Either_Right_flatMap(pony_ctx_t** _ctx, _enc__passive_Either_Right_t* _this, closure_t* _enc__arg_f)
{
  pony_type_t* _enc__type_a = (*((_enc__passive_Either_Right_t*) _this))._enc__type_a;
  pony_type_t* _enc__type_b = (*((_enc__passive_Either_Right_t*) _this))._enc__type_b;
  /* match this with
 ...
 */;
  ...
  if ((({int64_t _extractoCheck_16;
         _extractoCheck_16 = ((_this != NULL) && ({int64_t _optionCheck_14;
                                                   option_t* _extractedOption_12 = _enc__method_Either_Right_Left(_ctx, _this);
  ...
  else
  {
    ...
    if ((({int64_t _extractoCheck_10;
           _extractoCheck_10 = ((_this != NULL) && ({int64_t _optionCheck_8;
                                                     option_t* _extractedOption_6 = _enc__method_Either_Right_Right(_ctx, _this);
...
pony_type_t _enc__passive_Either_Right_type = {.id=_ENC__ID_Either_Right, .size=sizeof(_enc__passive_Either_Right_t), .trace=_enc__trace_Either_Right, .vtable=trait_method_selector};
