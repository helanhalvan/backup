...
void _enc__type_init_XML_lib(_enc__passive_XML_lib_t* this, ... )
{
  va_list params;
...
void _enc__trace_XML_lib(pony_ctx_t* _ctx_arg, void* p)
{
  pony_ctx_t** _ctx = (&(_ctx_arg));
  _enc__passive_XML_lib_t* _this = p;
}


_enc__passive_XML_lib_t* _enc__constructor_XML_lib(pony_ctx_t** _ctx)
{
  _enc__passive_XML_lib_t* this = ((_enc__passive_XML_lib_t*) encore_alloc((*_ctx), sizeof(_enc__passive_XML_lib_t)));
  this->_enc__self_type = (&(_enc__passive_XML_lib_type));
  return this;
}


void* _enc__method_XML_lib__init(pony_ctx_t** _ctx, _enc__passive_XML_lib_t* _this)
{
  /* () */;
  UNIT;
  return UNIT;
...
option_t* _enc__method_XML_lib_new_XML_node(pony_ctx_t** _ctx, _enc__passive_XML_lib_t* _this, _enc__passive_String_t* _enc__arg_s)
{
  /* let node = new XML_node() */;
  /* node = new XML_node() */;
  _enc__passive_XML_node_t* _new_0 = _enc__constructor_XML_node(_ctx);
  _enc__type_init_XML_node(_new_0);
  _enc__method_XML_node__init(_ctx, _new_0);
  _enc__passive_XML_node_t* _node_1 = _new_0;
  /* let bad = false */;
  /* bad = false */;
  int64_t _literal_2 = 0/*False*/;
  int64_t _bad_3 = _literal_2;
  /* s.trim() */;
  check_receiver(_enc__arg_s, ".", "s", "trim", "\"./encore-libs-master/XML/xml.enc\" (line 49, column 5)");
  _enc__passive_String_t* _sync_method_call_4 = _enc__method_String_trim(_ctx, _enc__arg_s);
  /* node.s_rep = s */;
  (*({ _node_1;}))._enc__field_s_rep = _enc__arg_s;
  /* let cont = new [String](s.occurrences("<")) */;
  /* cont = new [String](s.occurrences("<")) */;
  check_receiver(_enc__arg_s, ".", "s", "occurrences", "\"./encore-libs-master/XML/xml.enc\" (line 51, column 29)");
  _enc__passive_String_t* _new_7 = _enc__constructor_String(_ctx);
  char* _embed_8 = ({"<";});
  _enc__type_init_String(_new_7);
  _enc__method_String__init(_ctx, _new_7, _embed_8);
  int64_t _sync_method_call_6 = _enc__method_String_occurrences(_ctx, _enc__arg_s, _new_7);
  array_t* _array_5 = array_mk(_ctx, _sync_method_call_6, (&(_enc__passive_String_type)));
 ...
 */;
    ...
    check_receiver(_enc__arg_s, ".", "s", "char_at", "\"./encore-libs-master/XML/xml.enc\" (line 54, column 23)");
    int64_t _literal_17 = 0;
    option_t* _sync_method_call_16 = _enc__method_String_char_at(_ctx, _enc__arg_s, _literal_17);
    check_receiver(_enc__arg_s, ".", "s", "char_at", "\"./encore-libs-master/XML/xml.enc\" (line 54, column 36)");
    int64_t _binop_21 = (({check_receiver(_enc__arg_s, ".", "s", "size", "\"./encore-libs-master/XML/xml.enc\" (line 54, column 47)");
                           int64_t _sync_method_call_19 = _enc__method_String_size(_ctx, _enc__arg_s); _sync_method_call_19;}) - ({int64_t _literal_20 = 2; _literal_20;}));
    option_t* _sync_method_call_18 = _enc__method_String_char_at(_ctx, _enc__arg_s, _binop_21);
    check_receiver(_enc__arg_s, ".", "s", "char_at", "\"./encore-libs-master/XML/xml.enc\" (line 54, column 59)");
    int64_t _binop_25 = (({check_receiver(_enc__arg_s, ".", "s", "size", "\"./encore-libs-master/XML/xml.enc\" (line 54, column 69)");
                           int64_t _sync_method_call_23 = _enc__method_String_size(_ctx, _enc__arg_s); _sync_method_call_23;}) - ({int64_t _literal_24 = 1; _literal_24;}));
    option_t* _sync_method_call_22 = _enc__method_String_char_at(_ctx, _enc__arg_s, _binop_25);
           ...
           _tupleCheck_33 = (_tupleCheck_33 && _optionCheck_46); _tupleCheck_33;}) && ({int64_t _literal_49 = 1/*True*/; _literal_49;})))
    {
      _match_14 = ((option_t*) ({/* node.name = s */;
                                 ...
                                 /* this.ext_atribs(node, node.name) */;
                                 check_receiver(_this, ".", "this", "ext_atribs", "\"./encore-libs-master/XML/xml.enc\" (line 56, column 66)");
                                 _enc__passive_String_t* _fieldacc_27 = (*_node_1)._enc__field_name;
                                 void* _sync_method_call_26 = _enc__method_XML_lib_ext_atribs(_ctx, _this, _node_1, _fieldacc_27);
                                 /* Just node */;
                                 option_t* _option_28 = option_mk(_ctx, JUST, ((encore_arg_t) {.p = _node_1}), (&(_enc__passive_XML_node_type))); _option_28;}));
    }
    else
    {
      tuple_t* ___29;
  ...
  /* let start = s.find("<") */;
  /* start = s.find("<") */;
  check_receiver(_enc__arg_s, ".", "s", "find", "\"./encore-libs-master/XML/xml.enc\" (line 61, column 17)");
  _enc__passive_String_t* _new_52 = _enc__constructor_String(_ctx);
  char* _embed_53 = ({"<";});
  _enc__type_init_String(_new_52);
  _enc__method_String__init(_ctx, _new_52, _embed_53);
  int64_t _sync_method_call_51 = _enc__method_String_find(_ctx, _enc__arg_s, _new_52);
  ...
  while (((_index_58 >= _literal_64) && (_index_58 <= _binop_67)))
  {
    ...
    /* finnish = s.find_from(">", start) */;
    check_receiver(_enc__arg_s, ".", "s", "find_from", "\"./encore-libs-master/XML/xml.enc\" (line 65, column 17)");
    _enc__passive_String_t* _new_71 = _enc__constructor_String(_ctx);
    char* _embed_72 = ({">";});
    _enc__type_init_String(_new_71);
    _enc__method_String__init(_ctx, _new_71, _embed_72);
    int64_t _sync_method_call_70 = _enc__method_String_find_from(_ctx, _enc__arg_s, _new_71, _start_54);
  ...
  Nothing => ""
 */;
    check_receiver(_enc__arg_s, ".", "s", "substring", "\"./encore-libs-master/XML/xml.enc\" (line 66, column 24)");
    int64_t _binop_76 = (({ _finnish_56;}) + ({int64_t _literal_75 = 1; _literal_75;}));
    option_t* _sync_method_call_74 = _enc__method_String_substring(_ctx, _enc__arg_s, _start_54, _binop_76);
    _enc__passive_String_t* _match_73;
    _enc__passive_String_t* _sub_77;
    if ((({int64_t _optionCheck_84;
           _optionCheck_84 = ((JUST == (*_sync_method_call_74).tag) && ({int64_t _varBinding_85;
                                                                         _enc__passive_String_t* _optionVal_83 = (*_sync_method_call_74).val.p;
                                                                         _sub_77 = _optionVal_83;
                                                                         _varBinding_85 = 1; _varBinding_85;})); _optionCheck_84;}) && ({int64_t _literal_86 = 1/*True*/; _literal_86;})))
    {
      _match_73 = ((_enc__passive_String_t*) ({ _sub_77;}));
    }
    else
    {
      ...
      {
        _match_73 = ((_enc__passive_String_t*) ({_enc__passive_String_t* _new_78 = _enc__constructor_String(_ctx);
                                                 char* _embed_79 = ({"";});
                                                 _enc__type_init_String(_new_78);
                                                 _enc__method_String__init(_ctx, _new_78, _embed_79); _new_78;}));
      }
      else
      {
        printf("*** Runtime error: No matching clause was found ***\n");
    ...
    /* start = s.find_from("<", finnish) */;
    check_receiver(_enc__arg_s, ".", "s", "find_from", "\"./encore-libs-master/XML/xml.enc\" (line 69, column 15)");
    _enc__passive_String_t* _new_88 = _enc__constructor_String(_ctx);
    char* _embed_89 = ({"<";});
    _enc__type_init_String(_new_88);
    _enc__method_String__init(_ctx, _new_88, _embed_89);
    int64_t _sync_method_call_87 = _enc__method_String_find_from(_ctx, _enc__arg_s, _new_88, _finnish_56);
  ...
  _enc__passive_String_t* _access_91 = array_get(_cont_9, _literal_90).p;
  (*({ _node_1;}))._enc__field_name = _access_91;
  /* this.ext_atribs(node, node.name) */;
  check_receiver(_this, ".", "this", "ext_atribs", "\"./encore-libs-master/XML/xml.enc\" (line 72, column 5)");
  _enc__passive_String_t* _fieldacc_93 = (*_node_1)._enc__field_name;
  void* _sync_method_call_92 = _enc__method_XML_lib_ext_atribs(_ctx, _this, _node_1, _fieldacc_93);
  ...
  Nothing */;
  option_t* _ite_94;
  if (({check_receiver(_this, ".", "this", "pair", "\"./encore-libs-master/XML/xml.enc\" (line 73, column 9)");
        _enc__passive_String_t* _fieldacc_96 = (*_node_1)._enc__field_name;
        int64_t _binop_99 = (({int64_t _size_97 = array_size(_cont_9); _size_97;}) - ({int64_t _literal_98 = 1; _literal_98;}));
        _enc__passive_String_t* _access_100 = array_get(_cont_9, _binop_99).p;
        int64_t _sync_method_call_95 = _enc__method_XML_lib_pair(_ctx, _this, _fieldacc_96, _access_100); _sync_method_call_95;}))
  {
    /* node.comments = new [String](|cont|) */;
    int64_t _size_102 = array_size(_cont_9);
    array_t* _array_101 = array_mk(_ctx, _size_102, (&(_enc__passive_String_type)));
    ...
    array_t* _array_105 = array_mk(_ctx, _size_106, (&(_enc__passive_String_type)));
    ...
    /* let temp = "" */;
    /* temp = "" */;
    _enc__passive_String_t* _new_110 = _enc__constructor_String(_ctx);
    char* _embed_111 = ({"";});
    _enc__type_init_String(_new_110);
    _enc__method_String__init(_ctx, _new_110, _embed_111);
    _enc__passive_String_t* _temp_112 = _new_110;
    /* let level = 0 */;
    /* level = 0 */;
 ...
 */;
      ...
      check_receiver(_this, ".", "this", "tag_type", "\"./encore-libs-master/XML/xml.enc\" (line 83, column 22)");
      _enc__passive_String_t* _access_131 = array_get(_cont_9, _i_117).p;
      char _sync_method_call_130 = _enc__method_XML_lib_tag_type(_ctx, _this, _access_131);
             ...
             _tupleCheck_191 = (_tupleCheck_191 && _valueCheck_196); _tupleCheck_191;}) && ({int64_t _literal_198 = 1/*True*/; _literal_198;})))
      {
        _match_128 = ((void*) ({/* node.comments[ci] = cont[i] */;
                                _enc__passive_String_t* _access_132 = array_get(_cont_9, _i_117).p;
      ...
      else
      {
               ...
               _tupleCheck_183 = (_tupleCheck_183 && _valueCheck_188); _tupleCheck_183;}) && ({int64_t _literal_190 = 1/*True*/; _literal_190;})))
        {
          _match_128 = ((void*) ({/* babies[j] = cont[i] */;
                                  _enc__passive_String_t* _access_136 = array_get(_cont_9, _i_117).p;
        ...
        else
        {
                 ...
                 _tupleCheck_175 = (_tupleCheck_175 && _valueCheck_180); _tupleCheck_175;}) && ({int64_t _literal_182 = 1/*True*/; _literal_182;})))
          {
            _match_128 = ((void*) ({/* babies[j] = temp.concatenate(cont[i]) */;
                                    check_receiver(_temp_112, ".", "temp", "concatenate", "\"./encore-libs-master/XML/xml.enc\" (line 86, column 40)");
                                    _enc__passive_String_t* _access_140 = array_get(_cont_9, _i_117).p;
                                    _enc__passive_String_t* _sync_method_call_139 = _enc__method_String_concatenate(_ctx, _temp_112, _access_140);
          ...
          else
          {
                   ...
                   _tupleCheck_168 = (_tupleCheck_168 && _valueCheck_172); _tupleCheck_168;}) && ({int64_t _literal_174 = 1/*True*/; _literal_174;})))
            {
              _match_128 = ((void*) ({/* temp = temp.concatenate(cont[i]) */;
                                      check_receiver(_temp_112, ".", "temp", "concatenate", "\"./encore-libs-master/XML/xml.enc\" (line 87, column 35)");
                                      _enc__passive_String_t* _access_148 = array_get(_cont_9, _i_117).p;
                                      _enc__passive_String_t* _sync_method_call_147 = _enc__method_String_concatenate(_ctx, _temp_112, _access_148);
            ...
            else
            {
                     ...
                     _tupleCheck_161 = (_tupleCheck_161 && _valueCheck_165); _tupleCheck_161;}) && ({int64_t _literal_167 = 1/*True*/; _literal_167;})))
              {
                _match_128 = ((void*) ({/* temp = temp.concatenate(cont[i]) */;
                                        ...
                                        _enc__passive_String_t* _access_153 = array_get(_cont_9, _i_117).p;
                                        _enc__passive_String_t* _sync_method_call_152 = _enc__method_String_concatenate(_ctx, _temp_112, _access_153);
              ...
              else
              {
                ...
                {
                  _match_128 = ((void*) ({/* temp = temp.concatenate(cont[i]) */;
                                          check_receiver(_temp_112, ".", "temp", "concatenate", "\"./encore-libs-master/XML/xml.enc\" (line 89, column 28)");
                                          _enc__passive_String_t* _access_158 = array_get(_cont_9, _i_117).p;
                                          _enc__passive_String_t* _sync_method_call_157 = _enc__method_String_concatenate(_ctx, _temp_112, _access_158);
    ...
    /* node.children = new [XML_node](j) */;
    array_t* _array_199 = array_mk(_ctx, _j_109, (&(_enc__passive_XML_node_type)));
  ...
  Nothing => {bad = true;
              ()}
 */;
      check_receiver(_this, ".", "this", "new_XML_node", "\"./encore-libs-master/XML/xml.enc\" (line 94, column 15)");
      _enc__passive_String_t* _access_214 = array_get(_babies_107, _i_202).p;
      option_t* _sync_method_call_213 = _enc__method_XML_lib_new_XML_node(_ctx, _this, _access_214);
      void* _match_212;
      _enc__passive_XML_node_t* _xml_215;
      if ((({int64_t _optionCheck_222;
             _optionCheck_222 = ((JUST == (*_sync_method_call_213).tag) && ({int64_t _varBinding_223;
                                                                             _enc__passive_XML_node_t* _optionVal_221 = (*_sync_method_call_213).val.p;
  ...
  Nothing */;
    ...
    {
      /* Just node */;
      option_t* _option_228 = option_mk(_ctx, JUST, ((encore_arg_t) {.p = _node_1}), (&(_enc__passive_XML_node_type)));
...
char _enc__method_XML_lib_tag_type(pony_ctx_t** _ctx, _enc__passive_XML_lib_t* _this, _enc__passive_String_t* _enc__arg_s)
{
 ...
 */;
  check_receiver(_enc__arg_s, ".", "s", "char_at", "\"./encore-libs-master/XML/xml.enc\" (line 108, column 16)");
  int64_t _literal_2 = 1;
  option_t* _sync_method_call_1 = _enc__method_String_char_at(_ctx, _enc__arg_s, _literal_2);
  char _match_0;
  ...
  _ => 's'
 */;
                             check_receiver(_enc__arg_s, ".", "s", "char_at", "\"./encore-libs-master/XML/xml.enc\" (line 114, column 31)");
                             int64_t _binop_10 = (({check_receiver(_enc__arg_s, ".", "s", "size", "\"./encore-libs-master/XML/xml.enc\" (line 114, column 42)");
                                                    int64_t _sync_method_call_8 = _enc__method_String_size(_ctx, _enc__arg_s); _sync_method_call_8;}) - ({int64_t _literal_9 = 2; _literal_9;}));
                             option_t* _sync_method_call_7 = _enc__method_String_char_at(_ctx, _enc__arg_s, _binop_10);
                             char _match_6;
...
void* _enc__method_XML_lib_ext_atribs(pony_ctx_t** _ctx, _enc__passive_XML_lib_t* _this, _enc__passive_XML_node_t* _enc__arg_node, _enc__passive_String_t* _enc__arg_s)
{
  /* node.atribs = new [(String, String)](s.occurrences("=")) */;
  check_receiver(_enc__arg_s, ".", "s", "occurrences", "\"./encore-libs-master/XML/xml.enc\" (line 124, column 44)");
  ...
  int64_t _sync_method_call_1 = _enc__method_String_occurrences(_ctx, _enc__arg_s, _new_2);
  ...
  _enc__passive_String_t* _value_10 = _new_8;
  /* let key = "" */;
  /* key = "" */;
  _enc__passive_String_t* _new_11 = _enc__constructor_String(_ctx);
  char* _embed_12 = ({"";});
  _enc__type_init_String(_new_11);
  _enc__method_String__init(_ctx, _new_11, _embed_12);
  _enc__passive_String_t* _key_13 = _new_11;
  ...
  while (((_index_15 >= _literal_21) && (_index_15 <= _binop_25)))
  {
    ...
    /* space = s.find_from(" ", eqsign) */;
    check_receiver(_enc__arg_s, ".", "s", "find_from", "\"./encore-libs-master/XML/xml.enc\" (line 131, column 19)");
    ...
    int64_t _sync_method_call_28 = _enc__method_String_find_from(_ctx, _enc__arg_s, _new_29, _eqsign_5);
    _space_7 = _sync_method_call_28;
    /* eqsign = s.find_from("=", eqsign + 1) */;
    check_receiver(_enc__arg_s, ".", "s", "find_from", "\"./encore-libs-master/XML/xml.enc\" (line 132, column 20)");
    _enc__passive_String_t* _new_32 = _enc__constructor_String(_ctx);
    char* _embed_33 = ({"=";});
    _enc__type_init_String(_new_32);
    _enc__method_String__init(_ctx, _new_32, _embed_33);
    int64_t _binop_35 = (({ _eqsign_5;}) + ({int64_t _literal_34 = 1; _literal_34;}));
    int64_t _sync_method_call_31 = _enc__method_String_find_from(_ctx, _enc__arg_s, _new_32, _binop_35);
    ...
    /* value = match s.substring(eqsign + 2, 
          ...
          Nothing => "MISSFORMEDVALUE"
         */;
    check_receiver(_enc__arg_s, ".", "s", "substring", "\"./encore-libs-master/XML/xml.enc\" (line 133, column 25)");
    int64_t _binop_39 = (({ _eqsign_5;}) + ({int64_t _literal_38 = 2; _literal_38;}));
    int64_t _binop_46 = (({check_receiver(_this, ".", "this", "or_find_from", "\"./encore-libs-master/XML/xml.enc\" (line 133, column 46)");
                           ...
                           int64_t _sync_method_call_40 = _enc__method_XML_lib_or_find_from(_ctx, _this, _new_41, _new_43, _eqsign_5, _enc__arg_s); _sync_method_call_40;}) - ({int64_t _literal_45 = 1; _literal_45;}));
    option_t* _sync_method_call_37 = _enc__method_String_substring(_ctx, _enc__arg_s, _binop_39, _binop_46);
    _enc__passive_String_t* _match_36;
    _enc__passive_String_t* _derp_47;
    if ((({int64_t _optionCheck_54;
           _optionCheck_54 = ((JUST == (*_sync_method_call_37).tag) && ({int64_t _varBinding_55;
                                                                         _enc__passive_String_t* _optionVal_53 = (*_sync_method_call_37).val.p;
                                                                         _derp_47 = _optionVal_53;
                                                                         _varBinding_55 = 1; _varBinding_55;})); _optionCheck_54;}) && ({int64_t _literal_56 = 1/*True*/; _literal_56;})))
    {
      _match_36 = ((_enc__passive_String_t*) ({ _derp_47;}));
    }
    else
    {
      ...
      {
        _match_36 = ((_enc__passive_String_t*) ({_enc__passive_String_t* _new_48 = _enc__constructor_String(_ctx);
                                                 char* _embed_49 = ({"MISSFORMEDVALUE";});
                                                 _enc__type_init_String(_new_48);
                                                 _enc__method_String__init(_ctx, _new_48, _embed_49); _new_48;}));
      }
      else
      {
        printf("*** Runtime error: No matching clause was found ***\n");
    ...
    /* key = match s.substring(space, eqsign) with
        ...
        Nothing => "MISSFORMEDKEY"
       */;
    check_receiver(_enc__arg_s, ".", "s", "substring", "\"./encore-libs-master/XML/xml.enc\" (line 136, column 23)");
    option_t* _sync_method_call_58 = _enc__method_String_substring(_ctx, _enc__arg_s, _space_7, _eqsign_5);
    _enc__passive_String_t* _match_57;
    _enc__passive_String_t* _derp_59;
    if ((({int64_t _optionCheck_66;
           _optionCheck_66 = ((JUST == (*_sync_method_call_58).tag) && ({int64_t _varBinding_67;
                                                                         _enc__passive_String_t* _optionVal_65 = (*_sync_method_call_58).val.p;
                                                                         _derp_59 = _optionVal_65;
                                                                         _varBinding_67 = 1; _varBinding_67;})); _optionCheck_66;}) && ({int64_t _literal_68 = 1/*True*/; _literal_68;})))
    {
      _match_57 = ((_enc__passive_String_t*) ({ _derp_59;}));
    }
    else
    {
      ...
      {
        _match_57 = ((_enc__passive_String_t*) ({_enc__passive_String_t* _new_60 = _enc__constructor_String(_ctx);
                                                 char* _embed_61 = ({"MISSFORMEDKEY";});
                                                 _enc__type_init_String(_new_60);
                                                 _enc__method_String__init(_ctx, _new_60, _embed_61); _new_60;}));
      }
      else
      {
        printf("*** Runtime error: No matching clause was found ***\n");
    ...
    tuple_set_type(_tuple_69, 0, (&(_enc__passive_String_type)));
    tuple_set_type(_tuple_69, 1, (&(_enc__passive_String_type)));
...
int64_t _enc__method_XML_lib_or_find_from(pony_ctx_t** _ctx, _enc__passive_XML_lib_t* _this, _enc__passive_String_t* _enc__arg_a, _enc__passive_String_t* _enc__arg_b, int64_t _enc__arg_i, _enc__passive_String_t* _enc__arg_s)
{
  /* let w = s.find_from(a, i) */;
  /* w = s.find_from(a, i) */;
  check_receiver(_enc__arg_s, ".", "s", "find_from", "\"./encore-libs-master/XML/xml.enc\" (line 144, column 17)");
  int64_t _sync_method_call_0 = _enc__method_String_find_from(_ctx, _enc__arg_s, _enc__arg_a, _enc__arg_i);
  ...
  int64_t _sync_method_call_2 = _enc__method_String_find_from(_ctx, _enc__arg_s, _enc__arg_b, _enc__arg_i);
...
int64_t _enc__method_XML_lib_pair(pony_ctx_t** _ctx, _enc__passive_XML_lib_t* _this, _enc__passive_String_t* _enc__arg_head, _enc__passive_String_t* _enc__arg_tail)
{
  /* true */;
...
option_t* _enc__method_XML_lib_file_to_xml(pony_ctx_t** _ctx, _enc__passive_XML_lib_t* _this, _enc__passive_String_t* _enc__arg_fname)
{
  /* let f = new File("", "") */;
  /* f = new File("", "") */;
  _enc__passive_File_t* _new_0 = _enc__constructor_File(_ctx);
  ...
  _enc__type_init_File(_new_0);
  _enc__method_File__init(_ctx, _new_0, _new_1, _new_3);
  _enc__passive_File_t* _f_5 = _new_0;
  /* let s = "" */;
  /* s = "" */;
  ...
  _enc__passive_String_t* _s_8 = _new_6;
  /* f.open(fname, "r") */;
  check_receiver(_f_5, ".", "f", "open", "\"./encore-libs-master/XML/xml.enc\" (line 157, column 8)");
  _enc__passive_String_t* _new_10 = _enc__constructor_String(_ctx);
  char* _embed_11 = ({"r";});
  _enc__type_init_String(_new_10);
  _enc__method_String__init(_ctx, _new_10, _embed_11);
  void* _sync_method_call_9 = _enc__method_File_open(_ctx, _f_5, _enc__arg_fname, _new_10);
  /* while f.eof() != true
  s = s.concatenate(f.readline()) */;
  void* _while_17;
  while (({int64_t _binop_14 = (({check_receiver(_f_5, ".", "f", "eof", "\"./encore-libs-master/XML/xml.enc\" (line 159, column 14)");
                                  int64_t _sync_method_call_12 = _enc__method_File_eof(_ctx, _f_5); _sync_method_call_12;}) != ({int64_t _literal_13 = 1/*True*/; _literal_13;})); _binop_14;}))
  {
    /* s = s.concatenate(f.readline()) */;
    check_receiver(_s_8, ".", "s", "concatenate", "\"./encore-libs-master/XML/xml.enc\" (line 160, column 15)");
    check_receiver(_f_5, ".", "f", "readline", "\"./encore-libs-master/XML/xml.enc\" (line 160, column 29)");
    _enc__passive_String_t* _sync_method_call_16 = _enc__method_File_readline(_ctx, _f_5);
    _enc__passive_String_t* _sync_method_call_15 = _enc__method_String_concatenate(_ctx, _s_8, _sync_method_call_16);
    _s_8 = _sync_method_call_15;
    _while_17 = UNIT;
  };
  /* this.new_XML_node(s) */;
  check_receiver(_this, ".", "this", "new_XML_node", "\"./encore-libs-master/XML/xml.enc\" (line 164, column 8)");
  option_t* _sync_method_call_18 = _enc__method_XML_lib_new_XML_node(_ctx, _this, _s_8);
  return _sync_method_call_18;
}


static void _enc__dispatch_XML_lib(pony_ctx_t** _ctx, pony_actor_t* _a, pony_msg_t* _m)
{
  /* Stub! Might be used when we have dynamic dispatch on passive classes */
}


pony_type_t _enc__passive_XML_lib_type = {.id=_ENC__ID_XML_lib, .size=sizeof(_enc__passive_XML_lib_t), .trace=_enc__trace_XML_lib, .dispatch=_enc__dispatch_XML_lib, .vtable=trait_method_selector};
