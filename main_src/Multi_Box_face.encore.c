...
static void* trait_method_selector(int id)
{
  switch (id)
  {
    ...
    {
      return _enc__method__encore_libs_master_Ped_util_Box_Multi_Box_face_done;
      break;
    }
    default:
    {
...
future_t* _enc__method__encore_libs_master_Ped_util_Box_Multi_Box_face_space(pony_ctx_t** _ctx, _enc__passive__encore_libs_master_Ped_util_Box_Multi_Box_face_t* _this)
{
  ...
  check_receiver(_fieldacc_1, ".", "this.t", "space", "\"./encore-libs-master/Ped_util/Box.enc\" (line 44, column 46)");
...
void* _enc__method__encore_libs_master_Ped_util_Box_Multi_Box_face_add(pony_ctx_t** _ctx, _enc__passive__encore_libs_master_Ped_util_Box_Multi_Box_face_t* _this, _enc__passive__encore_libs_master_Ped_util_Agent_passive_Agent_t* _enc__arg_a)
{
  /* this.t.add(a) */;
  _enc__active__encore_libs_master_Ped_util_Box_Multi_Box_t* _fieldacc_1 = (*_this)._enc__field_t;
  check_receiver(_fieldacc_1, ".", "this.t", "add", "\"./encore-libs-master/Ped_util/Box.enc\" (line 45, column 30)");
...
future_t* _enc__method__encore_libs_master_Ped_util_Box_Multi_Box_face_move(pony_ctx_t** _ctx, _enc__passive__encore_libs_master_Ped_util_Box_Multi_Box_face_t* _this)
{
  /* this.t.move() */;
  _enc__active__encore_libs_master_Ped_util_Box_Multi_Box_t* _fieldacc_1 = (*_this)._enc__field_t;
  check_receiver(_fieldacc_1, ".", "this.t", "move", "\"./encore-libs-master/Ped_util/Box.enc\" (line 46, column 27)");
...
future_t* _enc__method__encore_libs_master_Ped_util_Box_Multi_Box_face_external_move(pony_ctx_t** _ctx, _enc__passive__encore_libs_master_Ped_util_Box_Multi_Box_face_t* _this, _enc__passive__encore_libs_master_Ped_util_Agent_passive_Agent_t* _enc__arg_a, tuple_t* _enc__arg_b)
{
  ...
  _enc__active__encore_libs_master_Ped_util_Box_Multi_Box_t* _fieldacc_1 = (*_this)._enc__field_t;
  check_receiver(_fieldacc_1, ".", "this.t", "external_move", "\"./encore-libs-master/Ped_util/Box.enc\" (line 47, column 57)");
...
future_t* _enc__method__encore_libs_master_Ped_util_Box_Multi_Box_face_agents(pony_ctx_t** _ctx, _enc__passive__encore_libs_master_Ped_util_Box_Multi_Box_face_t* _this)
{
  /* this.t.agents() */;
  _enc__active__encore_libs_master_Ped_util_Box_Multi_Box_t* _fieldacc_1 = (*_this)._enc__field_t;
  check_receiver(_fieldacc_1, ".", "this.t", "agents", "\"./encore-libs-master/Ped_util/Box.enc\" (line 48, column 37)");
...
void* _enc__method__encore_libs_master_Ped_util_Box_Multi_Box_face_start(pony_ctx_t** _ctx, _enc__passive__encore_libs_master_Ped_util_Box_Multi_Box_face_t* _this)
{
  ...
  printf("%s", _literal_0);
  /* this.t.start() */;
  _enc__active__encore_libs_master_Ped_util_Box_Multi_Box_t* _fieldacc_2 = (*_this)._enc__field_t;
  check_receiver(_fieldacc_2, ".", "this.t", "start", "\"./encore-libs-master/Ped_util/Box.enc\" (line 49, column 48)");
  future_t* _fut_1 = _enc__method__encore_libs_master_Ped_util_Box_Multi_Box_start_future(_ctx, _fieldacc_2);
  /* print("multi_start_done\n") */;
  char* _literal_3 = "multi_start_done\n";
  printf("%s", _literal_3);
  return UNIT;
}


void* _enc__method__encore_libs_master_Ped_util_Box_Multi_Box_face_done(pony_ctx_t** _ctx, _enc__passive__encore_libs_master_Ped_util_Box_Multi_Box_face_t* _this)
{
  /* this.t.done() */;
  _enc__active__encore_libs_master_Ped_util_Box_Multi_Box_t* _fieldacc_1 = (*_this)._enc__field_t;
  check_receiver(_fieldacc_1, ".", "this.t", "done", "\"./encore-libs-master/Ped_util/Box.enc\" (line 50, column 24)");
  future_t* _fut_0 = _enc__method__encore_libs_master_Ped_util_Box_Multi_Box_done_future(_ctx, _fieldacc_1);
  return UNIT;
}
