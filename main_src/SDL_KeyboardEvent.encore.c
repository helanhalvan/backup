...
pony_type_t _enc__passive_SDL_KeyboardEvent_type = {.id=_ENC__ID_SDL_KeyboardEvent, .size=sizeof(_enc__passive_SDL_KeyboardEvent_t), .trace=_enc__trace_SDL_KeyboardEvent, .vtable=trait_method_selector};
