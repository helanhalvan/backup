...
void _enc__type_init_SDL_KeyboardEvent(_enc__passive_SDL_KeyboardEvent_t* this, ... )
{
  va_list params;
...
void _enc__trace_SDL_KeyboardEvent(pony_ctx_t* _ctx_arg, void* p)
{
  pony_ctx_t** _ctx = (&(_ctx_arg));
  _enc__passive_SDL_KeyboardEvent_t* _this = p;
...
_enc__passive_SDL_KeyboardEvent_t* _enc__constructor_SDL_KeyboardEvent(pony_ctx_t** _ctx)
{
  _enc__passive_SDL_KeyboardEvent_t* this = ((_enc__passive_SDL_KeyboardEvent_t*) encore_alloc((*_ctx), sizeof(_enc__passive_SDL_KeyboardEvent_t)));
  this->_enc__self_type = (&(_enc__passive_SDL_KeyboardEvent_type));
  return this;
}


void* _enc__method_SDL_KeyboardEvent__init(pony_ctx_t** _ctx, _enc__passive_SDL_KeyboardEvent_t* _this, SDL_Event* _enc__arg_event)
{
...
static void _enc__dispatch_SDL_KeyboardEvent(pony_ctx_t** _ctx, pony_actor_t* _a, pony_msg_t* _m)
{
  /* Stub! Might be used when we have dynamic dispatch on passive classes */
}


pony_type_t _enc__passive_SDL_KeyboardEvent_type = {.id=_ENC__ID_SDL_KeyboardEvent, .size=sizeof(_enc__passive_SDL_KeyboardEvent_t), .trace=_enc__trace_SDL_KeyboardEvent, .dispatch=_enc__dispatch_SDL_KeyboardEvent, .vtable=trait_method_selector};
