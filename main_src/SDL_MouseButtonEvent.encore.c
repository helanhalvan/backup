...
void _enc__type_init_SDL_MouseButtonEvent(_enc__passive_SDL_MouseButtonEvent_t* this, ... )
{
  va_list params;
...
void _enc__trace_SDL_MouseButtonEvent(pony_ctx_t* _ctx_arg, void* p)
{
  pony_ctx_t** _ctx = (&(_ctx_arg));
  _enc__passive_SDL_MouseButtonEvent_t* _this = p;
...
_enc__passive_SDL_MouseButtonEvent_t* _enc__constructor_SDL_MouseButtonEvent(pony_ctx_t** _ctx)
{
  _enc__passive_SDL_MouseButtonEvent_t* this = ((_enc__passive_SDL_MouseButtonEvent_t*) encore_alloc((*_ctx), sizeof(_enc__passive_SDL_MouseButtonEvent_t)));
  this->_enc__self_type = (&(_enc__passive_SDL_MouseButtonEvent_type));
  return this;
}


void* _enc__method_SDL_MouseButtonEvent__init(pony_ctx_t** _ctx, _enc__passive_SDL_MouseButtonEvent_t* _this, SDL_Event* _enc__arg_event)
{
...
static void _enc__dispatch_SDL_MouseButtonEvent(pony_ctx_t** _ctx, pony_actor_t* _a, pony_msg_t* _m)
{
  /* Stub! Might be used when we have dynamic dispatch on passive classes */
}


pony_type_t _enc__passive_SDL_MouseButtonEvent_type = {.id=_ENC__ID_SDL_MouseButtonEvent, .size=sizeof(_enc__passive_SDL_MouseButtonEvent_t), .trace=_enc__trace_SDL_MouseButtonEvent, .dispatch=_enc__dispatch_SDL_MouseButtonEvent, .vtable=trait_method_selector};
