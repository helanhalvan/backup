...
pony_type_t _enc__passive_SDL_MouseButtonEvent_type = {.id=_ENC__ID_SDL_MouseButtonEvent, .size=sizeof(_enc__passive_SDL_MouseButtonEvent_t), .trace=_enc__trace_SDL_MouseButtonEvent, .vtable=trait_method_selector};
