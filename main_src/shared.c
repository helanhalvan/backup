 ...
 */;
  ...
  if ((({int64_t _optionCheck_10;
         _optionCheck_10 = ((JUST == (*_enc__arg_i).tag) && ({int64_t _varBinding_11;
                                                              _enc__passive_String_t* _optionVal_9 = (*_enc__arg_i).val.p;
                                                              _nr_1 = _optionVal_9;
  ...
  else
  {
           ...
           _varBinding_7 = 1; _varBinding_7;}) && ({int64_t _literal_8 = 1/*True*/; _literal_8;})))
    {
      _match_0 = ((_enc__passive_String_t*) ({/* print("orEmpty\n") */;
                                              ...
                                              char* _embed_4 = ({"orEmpty\n";});
                                              _enc__type_init_String(_new_3);
                                              _enc__method_String__init(_ctx, _new_3, _embed_4);
                                              printf("%s", ((_enc__passive_String_t*) _new_3)->_enc__field_data);
                                              /* "" */;
                                              _enc__passive_String_t* _new_5 = _enc__constructor_String(_ctx);
                                              char* _embed_6 = ({"";});
                                              _enc__type_init_String(_new_5);
                                              _enc__method_String__init(_ctx, _new_5, _embed_6); _new_5;}));
    }
    else
    {
