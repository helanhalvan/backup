...
in
  ...
  check_receiver(_fieldacc_2, ".", "this.agents", "size", "\"./encore-libs-master/Ped_util/Box.enc\" (line 220, column 26)");
  ...
  check_receiver(_fieldacc_5, ".", "this.agents", "get_data", "\"./encore-libs-master/Ped_util/Box.enc\" (line 221, column 16)");
  ...
  {b[i] = match a.next() with
   ...
   i = i + 1} */;
  void* _while_23;
  while (({check_receiver(_a_8, ".", "a", "has_next", "\"./encore-libs-master/Ped_util/Box.enc\" (line 225, column 11)");
           int64_t _sync_method_call_11 = _enc__method__encore_libs_master_Collections_HashMap_HashMapIterator_has_next(_ctx, _a_8); _sync_method_call_11;}))
  {
    /* b[i] = match a.next() with
         Just entry => entry.value.pos()
        */;
    check_receiver(_a_8, ".", "a", "next", "\"./encore-libs-master/Ped_util/Box.enc\" (line 226, column 20)");
                                                                         ...
                                                                         _varBinding_19 = 1; _varBinding_19;})); _optionCheck_18;}) && ({int64_t _literal_20 = 1/*True*/; _literal_20;})))
    {
      _match_12 = ((tuple_t*) ({_enc__passive__encore_libs_master_Ped_util_Agent_passive_Agent_t* _fieldacc_16 = (*_entry_14)._enc__field_value.p;
                                check_receiver(_fieldacc_16, ".", "entry.value", "pos", "\"./encore-libs-master/Ped_util/Box.enc\" (line 226, column 48)");
  ...
  if (({int64_t _binop_27 = (({ _i_10;}) < ({_enc__passive__encore_libs_master_Ped_util_Agent_passive_Agent_struct_t* _fieldacc_26 = (*_this)._enc__field_agents;
                                             check_receiver(_fieldacc_26, ".", "this.agents", "size", "\"./encore-libs-master/Ped_util/Box.enc\" (line 229, column 12)");
...
void* _enc__method__encore_libs_master_Ped_util_Box_Single_Box_add(pony_ctx_t** _ctx, _enc__active__encore_libs_master_Ped_util_Box_Single_Box_t* _this, _enc__passive__encore_libs_master_Ped_util_Agent_passive_Agent_t* _enc__arg_a)
{
  ...
  check_receiver(_fieldacc_1, ".", "this.agents", "add", "\"./encore-libs-master/Ped_util/Box.enc\" (line 240, column 27)");
...
{
  /* this!move() */;
  check_receiver(_this, " ! ", "this", "move", "\"./encore-libs-master/Ped_util/Box.enc\" (line 242, column 26)");
...
int64_t _enc__method__encore_libs_master_Ped_util_Box_Single_Box_move(pony_ctx_t** _ctx, _enc__active__encore_libs_master_Ped_util_Box_Single_Box_t* _this)
{
  ...
  _enc__passive__encore_libs_master_Ped_util_Agent_passive_Agent_struct_t* _fieldacc_2 = (*_this)._enc__field_agents;
  check_receiver(_fieldacc_2, ".", "this.agents", "get_data", "\"./encore-libs-master/Ped_util/Box.enc\" (line 245, column 51)");
  ...
  void* _while_168;
  while (({check_receiver(_iterator_3, ".", "iterator", "has_next", "\"./encore-libs-master/Ped_util/Box.enc\" (line 246, column 14)");
 ...
 */;
  ...
  Just entry => entry.value
 */;
    check_receiver(_iterator_3, ".", "iterator", "next", "\"./encore-libs-master/Ped_util/Box.enc\" (line 248, column 28)");
    ...
    /* desired = a.next() */;
    check_receiver(_a_13, ".", "a", "next", "\"./encore-libs-master/Ped_util/Box.enc\" (line 249, column 27)");
 ...
 */;
      ...
      if ((({int64_t _varBinding_152;
             ...
             _varBinding_152 = 1; _varBinding_152;}) && ({_enc__passive__encore_libs_master_Ped_util_Agent_passive_Agent_struct_t* _fieldacc_154 = (*_this)._enc__field_agents;
                                                          check_receiver(_fieldacc_154, ".", "this.agents", "isin", "\"./encore-libs-master/Ped_util/Box.enc\" (line 259, column 28)");
      ...
      else
      {
               ...
               _tupleCheck_124 = (_tupleCheck_124 && _tupleCheck_132); _tupleCheck_124;}) && ({int64_t _binop_151 = (({int64_t _binop_149 = (({int64_t _binop_147 = (({int64_t _binop_145 = (({ _x_40;}) <= ({ _x_max_42;})); _binop_145;}) && ({int64_t _binop_146 = (({ _x_40;}) >= ({ _x_min_44;})); _binop_146;})); _binop_147;}) && ({int64_t _binop_148 = (({ _y_41;}) <= ({ _y_max_43;})); _binop_148;})); _binop_149;}) && ({int64_t _binop_150 = (({ _y_41;}) >= ({ _y_min_45;})); _binop_150;})); _binop_151;})))
        {
          _match_33 = ((void*) ({/* a.move((x, y)) */;
                                 check_receiver(_a_13, ".", "a", "move", "\"./encore-libs-master/Ped_util/Box.enc\" (line 261, column 119)");
          ...
          else
          {
                   ...
                   _tupleCheck_70 = (_tupleCheck_70 && _tupleCheck_78); _tupleCheck_70;}) && ({int64_t _literal_91 = 1/*True*/; _literal_91;})))
            {
              _match_33 = ((void*) ({/* nejbor = this.toplevel.external_move(a.copy(), (x, y)) */;
                                     ...
                                     check_receiver(_fieldacc_64, ".", "this.toplevel", "external_move", "\"./encore-libs-master/Ped_util/Box.enc\" (line 266, column 71)");
                                     check_receiver(_a_13, ".", "a", "copy", "\"./encore-libs-master/Ped_util/Box.enc\" (line 266, column 99)");
  ...
  this.agents.remove(a) */;
    ...
    if (({int64_t _binop_165 = (({ _stillhere_22;}) == ({int64_t _literal_164 = 0/*False*/; _literal_164;})); _binop_165;}))
    {
      ...
      check_receiver(_fieldacc_167, ".", "this.agents", "remove", "\"./encore-libs-master/Ped_util/Box.enc\" (line 282, column 21)");
  ...
  /* this.agents.size() */;
  _enc__passive__encore_libs_master_Ped_util_Agent_passive_Agent_struct_t* _fieldacc_170 = (*_this)._enc__field_agents;
  check_receiver(_fieldacc_170, ".", "this.agents", "size", "\"./encore-libs-master/Ped_util/Box.enc\" (line 285, column 9)");
  int64_t _sync_method_call_169 = _enc__method__encore_libs_master_Ped_util_Agent_passive_Agent_struct_size(_ctx, _fieldacc_170);
  return ((int64_t) _sync_method_call_169);
}
...
int64_t _enc__method__encore_libs_master_Ped_util_Box_Single_Box_external_move(pony_ctx_t** _ctx, _enc__active__encore_libs_master_Ped_util_Box_Single_Box_t* _this, _enc__passive__encore_libs_master_Ped_util_Agent_passive_Agent_t* _enc__arg_a, tuple_t* _enc__arg_pos)
{
  ...
  {a.move(pos);
   ...
   true} */;
  int64_t _ite_0;
  if (({_enc__passive__encore_libs_master_Ped_util_Agent_passive_Agent_struct_t* _fieldacc_2 = (*_this)._enc__field_agents;
        check_receiver(_fieldacc_2, ".", "this.agents", "isin", "\"./encore-libs-master/Ped_util/Box.enc\" (line 289, column 8)");
        int64_t _sync_method_call_1 = _enc__method__encore_libs_master_Ped_util_Agent_passive_Agent_struct_isin(_ctx, _fieldacc_2, _enc__arg_pos); _sync_method_call_1;}))
  {
    /* false */;
  ...
  {
    /* a.move(pos) */;
    check_receiver(_enc__arg_a, ".", "a", "move", "\"./encore-libs-master/Ped_util/Box.enc\" (line 290, column 9)");
    void* _sync_method_call_4 = _enc__method__encore_libs_master_Ped_util_Agent_passive_Agent_move(_ctx, _enc__arg_a, _enc__arg_pos);
    /* this.agents.add(a) */;
    _enc__passive__encore_libs_master_Ped_util_Agent_passive_Agent_struct_t* _fieldacc_6 = (*_this)._enc__field_agents;
    check_receiver(_fieldacc_6, ".", "this.agents", "add", "\"./encore-libs-master/Ped_util/Box.enc\" (line 291, column 9)");
    void* _sync_method_call_5 = _enc__method__encore_libs_master_Ped_util_Agent_passive_Agent_struct_add(_ctx, _fieldacc_6, _enc__arg_a);
    /* true */;
    int64_t _literal_7 = 1/*True*/;
    _ite_0 = ((int64_t) _literal_7);
  };
