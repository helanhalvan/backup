...
pony_type_t _enc__passive_ColorRGBA_type = {.id=_ENC__ID_ColorRGBA, .size=sizeof(_enc__passive_ColorRGBA_t), .trace=_enc__trace_ColorRGBA, .vtable=trait_method_selector};
