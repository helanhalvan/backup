...
pony_type_t _enc__passive_SDL_MouseMotionEvent_type = {.id=_ENC__ID_SDL_MouseMotionEvent, .size=sizeof(_enc__passive_SDL_MouseMotionEvent_t), .trace=_enc__trace_SDL_MouseMotionEvent, .vtable=trait_method_selector};
