...
void _enc__type_init_SDL_MouseMotionEvent(_enc__passive_SDL_MouseMotionEvent_t* this, ... )
{
  va_list params;
...
void _enc__trace_SDL_MouseMotionEvent(pony_ctx_t* _ctx_arg, void* p)
{
  pony_ctx_t** _ctx = (&(_ctx_arg));
  _enc__passive_SDL_MouseMotionEvent_t* _this = p;
...
_enc__passive_SDL_MouseMotionEvent_t* _enc__constructor_SDL_MouseMotionEvent(pony_ctx_t** _ctx)
{
  _enc__passive_SDL_MouseMotionEvent_t* this = ((_enc__passive_SDL_MouseMotionEvent_t*) encore_alloc((*_ctx), sizeof(_enc__passive_SDL_MouseMotionEvent_t)));
  this->_enc__self_type = (&(_enc__passive_SDL_MouseMotionEvent_type));
  return this;
}


void* _enc__method_SDL_MouseMotionEvent__init(pony_ctx_t** _ctx, _enc__passive_SDL_MouseMotionEvent_t* _this, SDL_Event* _enc__arg_event)
{
...
static void _enc__dispatch_SDL_MouseMotionEvent(pony_ctx_t** _ctx, pony_actor_t* _a, pony_msg_t* _m)
{
  /* Stub! Might be used when we have dynamic dispatch on passive classes */
}


pony_type_t _enc__passive_SDL_MouseMotionEvent_type = {.id=_ENC__ID_SDL_MouseMotionEvent, .size=sizeof(_enc__passive_SDL_MouseMotionEvent_t), .trace=_enc__trace_SDL_MouseMotionEvent, .dispatch=_enc__dispatch_SDL_MouseMotionEvent, .vtable=trait_method_selector};
