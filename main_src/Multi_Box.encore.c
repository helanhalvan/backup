...
void* _enc__method__encore_libs_master_Ped_util_Box_Multi_Box_done(pony_ctx_t** _ctx, _enc__active__encore_libs_master_Ped_util_Box_Multi_Box_t* _this)
{
  /* let a = this.agents() */;
  /* a = this.agents() */;
  check_receiver(_this, ".", "this", "agents", "\"./encore-libs-master/Ped_util/Box.enc\" (line 162, column 17)");
  array_t* _sync_method_call_0 = _enc__method__encore_libs_master_Ped_util_Box_Multi_Box_agents(_ctx, _this);
  array_t* _a_1 = _sync_method_call_0;
  /* if |a| == 0 then
  this.toplevel.done() */;
  void* _ite_2;
  if (({int64_t _binop_5 = (({int64_t _size_3 = array_size(_a_1); _size_3;}) == ({int64_t _literal_4 = 0; _literal_4;})); _binop_5;}))
  {
    _enc__trait__encore_libs_master_Ped_util_Box_Box_face_t* _fieldacc_6 = (*_this)._enc__field_toplevel;
    check_receiver(_fieldacc_6, ".", "this.toplevel", "done", "\"./encore-libs-master/Ped_util/Box.enc\" (line 163, column 25)");
    void* (*_Box_face_done_7) (pony_ctx_t**, _enc__trait__encore_libs_master_Ped_util_Box_Box_face_t*);
    void* (*_Box_face_vtable_8) (int);
    _Box_face_vtable_8 = ((void*) _fieldacc_6->_enc__self_type->vtable);
    _Box_face_done_7 = _Box_face_vtable_8(_ENC__MSG__encore_libs_master_Ped_util_Box_Box_face_done);
    void* _trait_method_call_9 = _Box_face_done_7(_ctx, ((_enc__trait__encore_libs_master_Ped_util_Box_Box_face_t*) _fieldacc_6));
    _ite_2 = ((void*) _trait_method_call_9);
  }
  else
  {
    UNIT;
...
void* _enc__method__encore_libs_master_Ped_util_Box_Multi_Box_add(pony_ctx_t** _ctx, _enc__active__encore_libs_master_Ped_util_Box_Multi_Box_t* _this, _enc__passive__encore_libs_master_Ped_util_Agent_passive_Agent_t* _enc__arg_a)
{
  ...
  for item in this.multi
    if inside(a.pos(), this.space) then
      item.add(a.copy()) */;
  void* _ite_0;
  if (({check_receiver(_enc__arg_a, ".", "a", "pos", "\"./encore-libs-master/Ped_util/Box.enc\" (line 167, column 23)");
  ...
  item.add(a.copy()) */;
      void* _ite_15;
      if (({check_receiver(_enc__arg_a, ".", "a", "pos", "\"./encore-libs-master/Ped_util/Box.enc\" (line 169, column 29)");
      ...
      {
        check_receiver(_item_8, ".", "item", "add", "\"./encore-libs-master/Ped_util/Box.enc\" (line 169, column 57)");
        check_receiver(_enc__arg_a, ".", "a", "copy", "\"./encore-libs-master/Ped_util/Box.enc\" (line 169, column 66)");
...
in
  ...
  check_receiver(_access_2, ".", "this.multi[0]", "agents", "\"./encore-libs-master/Ped_util/Box.enc\" (line 175, column 21)");
  ...
  check_receiver(_access_9, ".", "this.multi[1]", "agents", "\"./encore-libs-master/Ped_util/Box.enc\" (line 176, column 21)");
  ...
  check_receiver(_access_16, ".", "this.multi[2]", "agents", "\"./encore-libs-master/Ped_util/Box.enc\" (line 177, column 21)");
  ...
  check_receiver(_access_23, ".", "this.multi[3]", "agents", "\"./encore-libs-master/Ped_util/Box.enc\" (line 178, column 21)");
...
int64_t _enc__method__encore_libs_master_Ped_util_Box_Multi_Box_external_move(pony_ctx_t** _ctx, _enc__active__encore_libs_master_Ped_util_Box_Multi_Box_t* _this, _enc__passive__encore_libs_master_Ped_util_Agent_passive_Agent_t* _enc__arg_a, tuple_t* _enc__arg_pos)
{
        ...
        int64_t _unary_4 = (! _global_f_3); _unary_4;}))
  {
    ...
    check_receiver(_fieldacc_5, ".", "this.toplevel", "external_move", "\"./encore-libs-master/Ped_util/Box.enc\" (line 185, column 17)");
  ...
  ret = item.external_move(a, pos) */;
      void* _ite_23;
      if (({check_receiver(_item_16, ".", "item", "space", "\"./encore-libs-master/Ped_util/Box.enc\" (line 189, column 36)");
      ...
      {
        /* ret = item.external_move(a, pos) */;
        check_receiver(_item_16, ".", "item", "external_move", "\"./encore-libs-master/Ped_util/Box.enc\" (line 190, column 25)");
...
int64_t _enc__method__encore_libs_master_Ped_util_Box_Multi_Box_move(pony_ctx_t** _ctx, _enc__active__encore_libs_master_Ped_util_Box_Multi_Box_t* _this)
{
  ...
  check_receiver(_access_5, ".", "this.multi[0]", "move", "\"./encore-libs-master/Ped_util/Box.enc\" (line 198, column 20)");
  ...
  check_receiver(_access_12, ".", "this.multi[1]", "move", "\"./encore-libs-master/Ped_util/Box.enc\" (line 199, column 20)");
  ...
  check_receiver(_access_19, ".", "this.multi[2]", "move", "\"./encore-libs-master/Ped_util/Box.enc\" (line 200, column 20)");
  ...
  check_receiver(_access_26, ".", "this.multi[3]", "move", "\"./encore-libs-master/Ped_util/Box.enc\" (line 201, column 20)");
...
void* _enc__method__encore_libs_master_Ped_util_Box_Multi_Box_start(pony_ctx_t** _ctx, _enc__active__encore_libs_master_Ped_util_Box_Multi_Box_t* _this)
{
  ...
  while (((_index_2 >= _start_4) && (_index_2 <= _stop_5)))
  {
    ...
    /* println(a) */;
    printf("Box.Box_face@%p\n", _a_3); //LAST PRINTOUT
    /* a.start() */;
    check_receiver(_a_3, ".", "a", "start", "\"./encore-libs-master/Ped_util/Box.enc\" (line 210, column 24)");
    void* (*_Box_face_start_10) (pony_ctx_t**, _enc__trait__encore_libs_master_Ped_util_Box_Box_face_t*);
    void* (*_Box_face_vtable_11) (int);
    _Box_face_vtable_11 = ((void*) _a_3->_enc__self_type->vtable); //LINE THAT CRASHES
  ...
  /* print("ing\n") */;
  char* _literal_13 = "ing\n";
  printf("%s", _literal_13);
  return UNIT;
}
...
future_t* _enc__method__encore_libs_master_Ped_util_Box_Multi_Box_done_future(pony_ctx_t** _ctx, _enc__active__encore_libs_master_Ped_util_Box_Multi_Box_t* _this)
{
  future_t* _fut = future_mk(_ctx, ENCORE_PRIMITIVE);
  pony_gc_send((*_ctx));
  encore_trace_object((*_ctx), _fut, future_trace);
  pony_send_done((*_ctx));
  _enc__fut_msg__encore_libs_master_Ped_util_Box_Multi_Box_done_t* msg = ((_enc__fut_msg__encore_libs_master_Ped_util_Box_Multi_Box_done_t*) pony_alloc_msg(POOL_INDEX(sizeof(_enc__fut_msg__encore_libs_master_Ped_util_Box_Multi_Box_done_t)), _ENC__FUT_MSG__encore_libs_master_Ped_util_Box_Multi_Box_done));
  msg->_fut = _fut;
  pony_sendv((*_ctx), ((pony_actor_t*) _this), ((pony_msg_t*) msg));
  return _fut;
}
...
void _enc__method__encore_libs_master_Ped_util_Box_Multi_Box_done_one_way(pony_ctx_t** _ctx, _enc__active__encore_libs_master_Ped_util_Box_Multi_Box_t* _this)
{
  pony_gc_send((*_ctx));
  /* No tracing future for oneway msg */;
  pony_send_done((*_ctx));
  _enc__oneway_msg__encore_libs_master_Ped_util_Box_Multi_Box_done_t* msg = ((_enc__oneway_msg__encore_libs_master_Ped_util_Box_Multi_Box_done_t*) pony_alloc_msg(POOL_INDEX(sizeof(_enc__oneway_msg__encore_libs_master_Ped_util_Box_Multi_Box_done_t)), _ENC__ONEWAY_MSG__encore_libs_master_Ped_util_Box_Multi_Box_done));
  pony_sendv((*_ctx), ((pony_actor_t*) _this), ((pony_msg_t*) msg));
}
...
static void _enc__dispatch__encore_libs_master_Ped_util_Box_Multi_Box(pony_ctx_t** _ctx, pony_actor_t* _a, pony_msg_t* _m)
{
  ...
  switch (_m->id)
  {
    ...
    case _ENC__FUT_MSG__encore_libs_master_Ped_util_Box_Multi_Box_done:
    {
      future_t* _fut = ((encore_fut_msg_t*) _m)->_fut;
      ...
      future_fulfil(_ctx, _fut, ((encore_arg_t) {.p = _enc__method__encore_libs_master_Ped_util_Box_Multi_Box_done(_ctx, _this)}));
      break;
    }
    case _ENC__ONEWAY_MSG__encore_libs_master_Ped_util_Box_Multi_Box_done:
    {
      ...
      _enc__method__encore_libs_master_Ped_util_Box_Multi_Box_done(_ctx, _this);
      break;
    }
