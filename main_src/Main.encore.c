...
in
  ...
  check_receiver(_this, ".", "this", "parse_file", "\"main.enc\" (line 22, column 31)");
  ...
  /* print("constructor-done!\n") */;
  char* _literal_11 = "constructor-done!\n";
  printf("%s", _literal_11);
  /* superbox!start() */;
  check_receiver(_superbox_4, " ! ", "superbox", "start", "\"main.enc\" (line 41, column 17)");
  _enc__method__encore_libs_master_Ped_util_Box_Top_Box_start_one_way(_ctx, _superbox_4);
  /* this!loop(superbox, 0, aui) */;
  check_receiver(_this, " ! ", "this", "loop", "\"main.enc\" (line 42, column 13)");
  int64_t _literal_12 = 0;
  _enc__method__main_Main_loop_one_way(_ctx, _this, _superbox_4, _literal_12, _aui_10);
  return UNIT;
}


void* _enc__method__main_Main_loop(pony_ctx_t** _ctx, _enc__active__main_Main_t* _this, _enc__active__encore_libs_master_Ped_util_Box_Top_Box_t* _enc__arg_superbox, int64_t _enc__arg_tick, int64_t _enc__arg_ui)
{
  /* print("tick {}\n", tick) */;
  printf("tick %lli\n", _enc__arg_tick);
   ...
   */;
  void* _for_0;
  check_receiver(_enc__arg_superbox, ".", "superbox", "agents", "\"main.enc\" (line 48, column 21)");
  future_t* _fut_7 = _enc__method__encore_libs_master_Ped_util_Box_Top_Box_agents_future(_ctx, _enc__arg_superbox);
  array_t* _tmp_8 = future_get_actor(_ctx, _fut_7).p;
  int64_t _start_3 = 0;
  int64_t _stop_4 = (array_size(_tmp_8) - 1);
  int64_t _src_step_6 = 1;
  int64_t _literal_9 = 1;
  int64_t _step_5 = (_literal_9 * _src_step_6);
  ...
  while (((_index_1 >= _start_3) && (_index_1 <= _stop_4)))
  {
    tuple_t* _a_2 = array_get(_tmp_8, _index_1).p;
    /* match a with
  (x, y) => ()
  _ => print("AGENT GOT NO POS!?\n")
 */;
    ...
    if ((({int64_t _tupleCheck_17;
           _tupleCheck_17 = 1;
           int64_t _tupleAccess_18 = tuple_get(_a_2, 0).i;
           int64_t _varBinding_19;
           _x_11 = _tupleAccess_18;
           _varBinding_19 = 1;
           _tupleCheck_17 = (_tupleCheck_17 && _varBinding_19);
           int64_t _tupleAccess_20 = tuple_get(_a_2, 1).i;
           int64_t _varBinding_21;
           _y_12 = _tupleAccess_20;
           _varBinding_21 = 1;
           _tupleCheck_17 = (_tupleCheck_17 && _varBinding_21); _tupleCheck_17;}) && ({int64_t _literal_22 = 1/*True*/; _literal_22;})))
    {
      _match_10 = ((void*) ({/* () */;
                             UNIT; UNIT;}));
    }
    else
    {
      ...
      {
        _match_10 = ((void*) ({char* _literal_14 = "AGENT GOT NO POS!?\n";
                               printf("%s", _literal_14); UNIT;}));
      }
      else
      {
  ...
  check_receiver(_this, " ! ", "this", "loop", "\"main.enc\" (line 54, column 13)");
  int64_t _binop_24 = (({ _enc__arg_tick;}) + ({int64_t _literal_23 = 1; _literal_23;}));
  _enc__method__main_Main_loop_one_way(_ctx, _this, _enc__arg_superbox, _binop_24, _enc__arg_ui);
  return UNIT;
}
...
in
  ...
  Nothing => print("\n\nBADXML!\n")
 */;
  check_receiver(_sen_1, ".", "sen", "file_to_xml", "\"main.enc\" (line 62, column 22)");
...
in
  ...
  check_receiver(_file_3, ".", "file", "children_named", "\"main.enc\" (line 66, column 27)");
 ...
 */;
    ...
    check_receiver(_a_32, ".", "a", "attribute_value", "\"main.enc\" (line 74, column 28)");
    ...
    check_receiver(_sync_method_call_41, ".", "a.attribute_value(new String.String(embed char* \"x\"; end))", "to_int", "\"main.enc\" (line 74, column 28)");
    option_t* _sync_method_call_40 = _enc__method_String_String_to_int(_ctx, _sync_method_call_41);
    check_receiver(_a_32, ".", "a", "attribute_value", "\"main.enc\" (line 74, column 60)");
    ...
    check_receiver(_sync_method_call_45, ".", "a.attribute_value(new String.String(embed char* \"y\"; end))", "to_int", "\"main.enc\" (line 74, column 60)");
    ...
    /* waypoints_distance[i] = int_or_0(a.attribute_value("r").to_int()) */;
    check_receiver(_a_32, ".", "a", "attribute_value", "\"main.enc\" (line 77, column 53)");
    ...
    check_receiver(_sync_method_call_69, ".", "a.attribute_value(new String.String(embed char* \"r\"; end))", "to_int", "\"main.enc\" (line 77, column 53)");
  ...
  nr_agents = nr_agents + match a.attribute_value("n").to_int() with
                           ...
                           */;
  void* _for_78;
  check_receiver(_file_3, ".", "file", "children_named", "\"main.enc\" (line 84, column 25)");
  ...
  _ => {print("BADINT2!\n");
        0}
 */;
                                                  check_receiver(_a_80, ".", "a", "attribute_value", "\"main.enc\" (line 86, column 34)");
                                                  ...
                                                  check_receiver(_sync_method_call_91, ".", "a.attribute_value(new String.String(embed char* \"n\"; end))", "to_int", "\"main.enc\" (line 86, column 34)");
    ...
    {for b in a.children_named("addway")
     ...
     for unused in [ 0 , max by 1 ]
       {if dx > x + dx_max then
        ...
        i = i + 1}} */;
  void* _for_109;
  check_receiver(_file_3, ".", "file", "children_named", "\"main.enc\" (line 94, column 37)");
...
in
  {for b in a.children_named("addway")
   ...
   for unused in [ 0 , max by 1 ]
    ...
    check_receiver(_a_111, ".", "a", "attribute_value", "\"main.enc\" (line 96, column 51)");
    ...
    check_receiver(_sync_method_call_121, ".", "a.attribute_value(new String.String(embed char* \"n\"; end))", "to_int", "\"main.enc\" (line 96, column 51)");
    ...
    /* x = int_or_0(a.attribute_value("xs").to_int()) */;
    check_receiver(_a_111, ".", "a", "attribute_value", "\"main.enc\" (line 97, column 49)");
    ...
    check_receiver(_sync_method_call_128, ".", "a.attribute_value(new String.String(embed char* \"xs\"; end))", "to_int", "\"main.enc\" (line 97, column 49)");
    ...
    /* y = int_or_0(a.attribute_value("ys").to_int()) */;
    check_receiver(_a_111, ".", "a", "attribute_value", "\"main.enc\" (line 98, column 49)");
    ...
    check_receiver(_sync_method_call_135, ".", "a.attribute_value(new String.String(embed char* \"ys\"; end))", "to_int", "\"main.enc\" (line 98, column 49)");
    ...
    /* dx_max = int_or_0(a.attribute_value("dx").to_int()) */;
    check_receiver(_a_111, ".", "a", "attribute_value", "\"main.enc\" (line 99, column 54)");
    ...
    check_receiver(_sync_method_call_142, ".", "a.attribute_value(new String.String(embed char* \"dx\"; end))", "to_int", "\"main.enc\" (line 99, column 54)");
    ...
    /* dy_max = int_or_0(a.attribute_value("dy").to_int()) */;
    check_receiver(_a_111, ".", "a", "attribute_value", "\"main.enc\" (line 100, column 54)");
    ...
    check_receiver(_sync_method_call_149, ".", "a.attribute_value(new String.String(embed char* \"dy\"; end))", "to_int", "\"main.enc\" (line 100, column 54)");
    ...
    /* agent_waypoints = new [(int, int)](|a.children_named("addway")|) */;
    check_receiver(_a_111, ".", "a", "children_named", "\"main.enc\" (line 101, column 69)");
  ...
  {agent_waypoints[j] = waypoints[int_or_0(string_or_empty(b.attribute_value("id").substring(1, 
   ...
   j = j + 1} */;
    void* _for_165;
    check_receiver(_a_111, ".", "a", "children_named", "\"main.enc\" (line 106, column 49)");
    ...
    while (((_index_166 >= _start_168) && (_index_166 <= _stop_169)))
    {
      ...
      /* agent_waypoints[j] = waypoints[int_or_0(string_or_empty(b.attribute_value("id").substring(1, 
                                                                                          2)).to_int()) - 1] */;
      int64_t _binop_188 = (({check_receiver(_b_167, ".", "b", "attribute_value", "\"main.enc\" (line 107, column 98)");
                              ...
                              check_receiver(_sync_method_call_178, ".", "b.attribute_value(new String.String(embed char* \"id\"; end))", "substring", "\"main.enc\" (line 107, column 98)");
...
future_t* _enc__method__main_Main_loop_future(pony_ctx_t** _ctx, _enc__active__main_Main_t* _this, _enc__active__encore_libs_master_Ped_util_Box_Top_Box_t* _enc__arg_superbox, int64_t _enc__arg_tick, int64_t _enc__arg_ui)
{
  future_t* _fut = future_mk(_ctx, ENCORE_PRIMITIVE);
  pony_gc_send((*_ctx));
...
void _enc__method__main_Main_loop_one_way(pony_ctx_t** _ctx, _enc__active__main_Main_t* _this, _enc__active__encore_libs_master_Ped_util_Box_Top_Box_t* _enc__arg_superbox, int64_t _enc__arg_tick, int64_t _enc__arg_ui)
{
  pony_gc_send((*_ctx));
  encore_trace_actor((*_ctx), ((pony_actor_t*) _enc__arg_superbox));
  /* Not tracing field '_enc__arg_tick' */;
...
static void _enc__dispatch__main_Main(pony_ctx_t** _ctx, pony_actor_t* _a, pony_msg_t* _m)
{
  ...
  switch (_m->id)
  {
    ...
    case _ENC__FUT_MSG__main_Main_loop:
    {
      ...
      future_fulfil(_ctx, _fut, ((encore_arg_t) {.p = _enc__method__main_Main_loop(_ctx, _this, _enc__arg_superbox, _enc__arg_tick, _enc__arg_ui)}));
      break;
    }
    case _ENC__ONEWAY_MSG__main_Main_loop:
    {
      ...
      _enc__method__main_Main_loop(_ctx, _this, _enc__arg_superbox, _enc__arg_tick, _enc__arg_ui);
      break;
    }
