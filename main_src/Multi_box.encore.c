...
in
  ...
  (xmax, ymax, xmin, ymin) => {this.max = (xmax, ymax);
                               ...
                               print("br {} {}\n", 
                                     ...
                                     get this.bottom_right.min())}
 */;
  check_receiver(_this, ".", "this", "find_extreme", "\"main.enc\" (line 216, column 15)");
         ...
         _tupleCheck_100 = (_tupleCheck_100 && _varBinding_108); _tupleCheck_100;}) && ({int64_t _literal_109 = 1/*True*/; _literal_109;})))
  {
    _match_4 = ((void*) ({/* this.max = (xmax, ymax) */;
      ...
      get this.top_right.min()) */;
                          ...
                          check_receiver(_fieldacc_77, ".", "this.top_right", "max", "\"main.enc\" (line 227, column 62)");
                          ...
                          check_receiver(_fieldacc_80, ".", "this.top_right", "min", "\"main.enc\" (line 227, column 88)");
      ...
      get this.bottom_left.min()) */;
                          ...
                          check_receiver(_fieldacc_83, ".", "this.bottom_left", "max", "\"main.enc\" (line 228, column 62)");
                          ...
                          check_receiver(_fieldacc_86, ".", "this.bottom_left", "min", "\"main.enc\" (line 228, column 90)");
      ...
      get this.top_left.min()) */;
                          ...
                          check_receiver(_fieldacc_89, ".", "this.top_left", "max", "\"main.enc\" (line 229, column 62)");
                          ...
                          check_receiver(_fieldacc_92, ".", "this.top_left", "min", "\"main.enc\" (line 229, column 87)");
      ...
      get this.bottom_right.min()) */;
                          ...
                          check_receiver(_fieldacc_95, ".", "this.bottom_right", "max", "\"main.enc\" (line 230, column 62)");
                          ...
                          check_receiver(_fieldacc_98, ".", "this.bottom_right", "min", "\"main.enc\" (line 230, column 91)");
  ...
  print("SOMEONE GOT NO BOX!\n") */;
    ...
    if (({_enc__active_Box_t* _fieldacc_120 = (*_this)._enc__field_top_right;
          check_receiver(_fieldacc_120, ".", "this.top_right", "add", "\"main.enc\" (line 235, column 25)");
  ...
  if not get this.bottom_right.add(a) then
    if not get this.bottom_left.add(a) then
      ...
      if (({_enc__active_Box_t* _fieldacc_125 = (*_this)._enc__field_top_left;
            check_receiver(_fieldacc_125, ".", "this.top_left", "add", "\"main.enc\" (line 236, column 25)");
  ...
  if not get this.bottom_left.add(a) then
    () */;
        ...
        if (({_enc__active_Box_t* _fieldacc_130 = (*_this)._enc__field_bottom_right;
              check_receiver(_fieldacc_130, ".", "this.bottom_right", "add", "\"main.enc\" (line 237, column 25)");
  ...
  () */;
          ...
          if (({_enc__active_Box_t* _fieldacc_135 = (*_this)._enc__field_bottom_left;
                check_receiver(_fieldacc_135, ".", "this.bottom_left", "add", "\"main.enc\" (line 238, column 25)");
  ...
  int64_t _binop_145 = (({ _win_140;}) && ({_enc__active_Box_t* _fieldacc_142 = (*_this)._enc__field_top_right;
                                            check_receiver(_fieldacc_142, ".", "this.top_right", "link", "\"main.enc\" (line 243, column 26)");
  ...
  int64_t _binop_150 = (({ _win_140;}) && ({_enc__active_Box_t* _fieldacc_147 = (*_this)._enc__field_top_right;
                                            check_receiver(_fieldacc_147, ".", "this.top_right", "link", "\"main.enc\" (line 244, column 26)");
  ...
  int64_t _binop_155 = (({ _win_140;}) && ({_enc__active_Box_t* _fieldacc_152 = (*_this)._enc__field_top_left;
                                            check_receiver(_fieldacc_152, ".", "this.top_left", "link", "\"main.enc\" (line 245, column 26)");
  ...
  int64_t _binop_160 = (({ _win_140;}) && ({_enc__active_Box_t* _fieldacc_157 = (*_this)._enc__field_top_left;
                                            check_receiver(_fieldacc_157, ".", "this.top_left", "link", "\"main.enc\" (line 246, column 26)");
  ...
  int64_t _binop_165 = (({ _win_140;}) && ({_enc__active_Box_t* _fieldacc_162 = (*_this)._enc__field_bottom_left;
                                            check_receiver(_fieldacc_162, ".", "this.bottom_left", "link", "\"main.enc\" (line 247, column 26)");
  ...
  int64_t _binop_170 = (({ _win_140;}) && ({_enc__active_Box_t* _fieldacc_167 = (*_this)._enc__field_bottom_left;
                                            check_receiver(_fieldacc_167, ".", "this.bottom_left", "link", "\"main.enc\" (line 248, column 26)");
  ...
  int64_t _binop_175 = (({ _win_140;}) && ({_enc__active_Box_t* _fieldacc_172 = (*_this)._enc__field_bottom_right;
                                            check_receiver(_fieldacc_172, ".", "this.bottom_right", "link", "\"main.enc\" (line 249, column 26)");
  ...
  int64_t _binop_180 = (({ _win_140;}) && ({_enc__active_Box_t* _fieldacc_177 = (*_this)._enc__field_bottom_right;
                                            check_receiver(_fieldacc_177, ".", "this.bottom_right", "link", "\"main.enc\" (line 250, column 26)");
  ...
  check_receiver(_fieldacc_182, ".", "this.top_right", "default_link", "\"main.enc\" (line 253, column 9)");
  ...
  check_receiver(_fieldacc_185, ".", "this.top_left", "default_link", "\"main.enc\" (line 254, column 9)");
  ...
  check_receiver(_fieldacc_188, ".", "this.bottom_right", "default_link", "\"main.enc\" (line 255, column 9)");
  ...
  check_receiver(_fieldacc_191, ".", "this.bottom_left", "default_link", "\"main.enc\" (line 256, column 9)");
...
in
  ...
  check_receiver(_fieldacc_1, ".", "this.top_right", "alive", "\"main.enc\" (line 268, column 13)");
  ...
  check_receiver(_fieldacc_4, ".", "this.top_left", "alive", "\"main.enc\" (line 269, column 13)");
  ...
  check_receiver(_fieldacc_7, ".", "this.bottom_right", "alive", "\"main.enc\" (line 270, column 13)");
  ...
  check_receiver(_fieldacc_10, ".", "this.bottom_left", "alive", "\"main.enc\" (line 271, column 13)");
  ...
  check_receiver(_fieldacc_23, ".", "this.top_right", "move", "\"main.enc\" (line 276, column 13)");
  ...
  check_receiver(_fieldacc_25, ".", "this.top_left", "move", "\"main.enc\" (line 277, column 13)");
  ...
  check_receiver(_fieldacc_27, ".", "this.bottom_right", "move", "\"main.enc\" (line 278, column 13)");
  ...
  check_receiver(_fieldacc_29, ".", "this.bottom_left", "move", "\"main.enc\" (line 279, column 13)");
...
array_t* _enc__method_Multi_box_agents(pony_ctx_t** _ctx, _enc__active_Multi_box_t* _this)
{
  ...
  check_receiver(_fieldacc_2, ".", "this.top_right", "agents", "\"main.enc\" (line 283, column 43)");
  ...
  check_receiver(_fieldacc_5, ".", "this.top_left", "agents", "\"main.enc\" (line 284, column 34)");
  ...
  check_receiver(_fieldacc_8, ".", "this.bottom_right", "agents", "\"main.enc\" (line 285, column 34)");
  ...
  check_receiver(_fieldacc_11, ".", "this.bottom_left", "agents", "\"main.enc\" (line 286, column 34)");
...
tuple_t* _enc__method_Multi_box_find_extreme(pony_ctx_t** _ctx, _enc__active_Multi_box_t* _this, array_t* _enc__arg_agents)
{
  ...
  while (((_index_11 >= _start_13) && (_index_11 <= _stop_14)))
  {
    ...
    _i_9 = _binop_19;
    /* extreme = this.extreme_check(a.pos(), extreme) */;
    check_receiver(_this, ".", "this", "extreme_check", "\"main.enc\" (line 293, column 21)");
    check_receiver(_a_12, ".", "a", "pos", "\"main.enc\" (line 293, column 40)");
  ...
  extreme = this.extreme_check(b, extreme) */;
    ...
    while (((_index_23 >= _start_25) && (_index_23 <= _stop_26)))
    {
      ...
      /* extreme = this.extreme_check(b, extreme) */;
      check_receiver(_this, ".", "this", "extreme_check", "\"main.enc\" (line 295, column 25)");
