...
void _enc__type_init__encore_libs_master_XML_XML_XML_node(_enc__passive__encore_libs_master_XML_XML_XML_node_t* this, ... )
{
  va_list params;
...
_enc__passive__encore_libs_master_XML_XML_XML_node_t* _enc__constructor__encore_libs_master_XML_XML_XML_node(pony_ctx_t** _ctx)
{
  _enc__passive__encore_libs_master_XML_XML_XML_node_t* this = ((_enc__passive__encore_libs_master_XML_XML_XML_node_t*) encore_alloc((*_ctx), sizeof(_enc__passive__encore_libs_master_XML_XML_XML_node_t)));
  this->_enc__self_type = (&(_enc__passive__encore_libs_master_XML_XML_XML_node_type));
  return this;
}


void* _enc__method__encore_libs_master_XML_XML_XML_node__init(pony_ctx_t** _ctx, _enc__passive__encore_libs_master_XML_XML_XML_node_t* _this)
{
  /* () */;
  UNIT;
  return UNIT;
...
array_t* _enc__method__encore_libs_master_XML_XML_XML_node_children_named(pony_ctx_t** _ctx, _enc__passive__encore_libs_master_XML_XML_XML_node_t* _this, _enc__passive_String_String_t* _enc__arg_name)
{
  ...
  {cn[i] = a;
   i = i + 1} */;
    void* _ite_15;
    if (({_enc__passive_String_String_t* _fieldacc_17 = (*_a_8)._enc__field_name;
          check_receiver(_fieldacc_17, ".", "a.name", "contains", "\"./encore-libs-master/XML/XML.enc\" (line 17, column 16)");
          int64_t _sync_method_call_16 = _enc__method_String_String_contains(_ctx, _fieldacc_17, _enc__arg_name); _sync_method_call_16;}))
    {
      /* cn[i] = a */;
  ...
  /* cn2 = new [XML_node](i) */;
  array_t* _array_20 = array_mk(_ctx, _i_5, (&(_enc__passive__encore_libs_master_XML_XML_XML_node_type)));
  ...
  {
    _enc__passive__encore_libs_master_XML_XML_XML_node_t* _a_25 = array_get(_cn2_21, _index_24).p;
    /* cn2[i] = cn[i] */;
    _enc__passive__encore_libs_master_XML_XML_XML_node_t* _access_31 = array_get(_cn_3, _i_5).p;
...
_enc__passive_String_String_t* _enc__method__encore_libs_master_XML_XML_XML_node_attribute_value(pony_ctx_t** _ctx, _enc__passive__encore_libs_master_XML_XML_XML_node_t* _this, _enc__passive_String_String_t* _enc__arg_name)
{
  /* let ret = "" */;
  /* ret = "" */;
  ...
  _enc__passive_String_String_t* _ret_2 = _new_0;
 ...
 */;
    void* _match_12;
    _enc__passive_String_String_t* _key_13;
    _enc__passive_String_String_t* _value_14;
    if ((({int64_t _tupleCheck_18;
           _tupleCheck_18 = 1;
           _enc__passive_String_String_t* _tupleAccess_19 = tuple_get(_a_5, 0).p;
           int64_t _varBinding_20;
           _key_13 = _tupleAccess_19;
           _varBinding_20 = 1;
           _tupleCheck_18 = (_tupleCheck_18 && _varBinding_20);
           _enc__passive_String_String_t* _tupleAccess_21 = tuple_get(_a_5, 1).p;
           int64_t _varBinding_22;
           _value_14 = _tupleAccess_21;
           _varBinding_22 = 1;
           _tupleCheck_18 = (_tupleCheck_18 && _varBinding_22); _tupleCheck_18;}) && ({check_receiver(_key_13, ".", "key", "contains", "\"./encore-libs-master/XML/XML.enc\" (line 36, column 34)");
                                                                                       int64_t _sync_method_call_23 = _enc__method_String_String_contains(_ctx, _key_13, _enc__arg_name); _sync_method_call_23;})))
    {
  ...
  /* ret */;
  return ((_enc__passive_String_String_t*) _ret_2);
}
